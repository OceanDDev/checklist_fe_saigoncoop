          ...
          <section className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
            {yearList.map((y) => {
                  ...
                  <p className="mt-2 text-sm text-white/85">
                    {stats.hasData ? (
                      <>
                        ...
                        <span className="font-semibold text-blue-200">{stats.monthCount}</span> tháng
                      ...
                      isCurrentYear 
                        ? `Bắt đầu quản lý KPI Xuất Hàng năm ${y}.`
                        : isFutureYear
                  ...
                  <div className="mt-5 flex items-center justify-between text-xs">
                    <div className="text-white/75">
                      {stats.hasData ? (
                        ...
                        <span>Kỳ: <span className="font-semibold text-white">12 tháng</span></span>
                      )}
                    </div>
              ...
              return (
                <Link
                  key={y}
                  to={`/kpi/homestaff/xuat-hang/table/${y}`}
                  aria-label={`Mở KPI Xuất Hàng năm ${y}`}

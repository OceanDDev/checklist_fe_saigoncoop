          ...
          <div className="flex items-center gap-2">
            ...
            {isAdminRole && (
              <button
                ...
                className="h-10 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 px-4 text-white hover:from-red-700 hover:to-rose-700 whitespace-nowrap font-medium flex items-center gap-2 shadow-sm"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"

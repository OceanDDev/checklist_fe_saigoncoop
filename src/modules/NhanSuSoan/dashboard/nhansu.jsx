  ...
  /** Đọc role người dùng hiện tại từ localStorage, dùng để ẩn nút theo role 76. */
            ...
            <div className="mb-4 flex flex-wrap items-center gap-3 rounded-xl border border-amber-200 bg-amber-50/60 px-3 py-2.5">
              ...
              {theoGio && (
                <span className="ml-auto text-xs font-medium text-purple-600">
                  🎯 Đang áp dụng KPI theo giờ ({vaiTroLabel}): ≥
                  {kpiGioTarget.kien} kiện/h hoặc ≥{kpiGioTarget.dong} dòng/h
                </span>
              )}
            </div>
          )}

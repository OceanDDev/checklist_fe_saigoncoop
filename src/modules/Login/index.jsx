  ...
  const LoginPage = () => {
    ...
    const handleLogin = async (e) => {
      ...
      try {
        ...
        // ✅ Redirect theo role - đổi field và đường dẫn cho đúng
        const role = res.user.role;
        setTimeout(() => {
          if (role === 20 || role === 26) {
            window.location.href = "/phieusoan"; // full reload → Cloudflare check IP
          } else {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 mt-1 rounded-lg border border-gray-300 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 pr-10"
                  />
                  <span

...
const TTBExportExcel = ({ thietBiList }) => {
  const exportToExcel = async () => {
    try {
      message.loading({ content: "Đang tải dữ liệu và tạo file Excel...", key: "export" });
      ...
      const dbHeaders = [
        "_id", "ngay_di", "ngay_ve", "so_bb", "ma_cua_hang", "ten_cua_hang",
        "tai_xe", "bien_so_xe", "ghi_chu"
      ];
      ...
      allData.forEach(record => {
        ...
        const row = [
          record._id,
          record.day?.ngay_di ? dayjs(record.day.ngay_di).format("YYYY-MM-DD") : "",
          record.day?.ngay_ve ? dayjs(record.day.ngay_ve).format("YYYY-MM-DD") : "",
          record.so_bb || "",
        ...
        thietBiList.forEach(thietBi => {
          const ttb = record.ttb?.find(t => t.ten_ttb === thietBi.ten_thiet_bi);
      ...
      inputLabelCell.font = { size: 14, bold: true, color: { argb: "FFFFFFFF" } };
      inputLabelCell.alignment = { vertical: "middle", horizontal: "center" };
      inputLabelCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FF1890FF" } };
      ...
      tenCHCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FF722ED1" } };
      ...
      thietBiList.forEach((thietBi, index) => {
        const colors = ["FF10B981", "FF3B82F6", "FFF59E0B", "FFEF4444", "FF8B5CF6", "FFEC4899"];
        ...
        tbCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: color } };
        tbCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
      ...
      dataRows.forEach((row, rowIdx) => {
        ...
        labelCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: row.bgColor } };
        ...
        thietBiList.forEach((tb, tbIdx) => {
          ...
          const diRange = `${diColLetter}${dataStartRow}:${diColLetter}${dataStartRow + maxRows - 1}`;
          const traRange = `${traColLetter}${dataStartRow}:${traColLetter}${dataStartRow + maxRows - 1}`;
          ...
          if (row.type === "opening") {
            ...
            cell1.value = { formula: `${openingCol}${openingRow}+${openingCol}${transactionRow}-${traCol}${transactionRow}` };
          }
          cell1.numFmt = "#,##0";
      ...
      thietBiList.forEach((thietBi, index) => {
        ...
        const startCol = colIndex;
        sheet.mergeCells(detailStartRow, startCol, detailStartRow, startCol + 1);
        ...
        diCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: color } };
        diCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        sheet.getColumn(startCol).width = 12;
        ...
        traCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: color } };
        traCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        sheet.getColumn(startCol + 1).width = 12;
      ...
      ghiChuCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FF64748B" } };
      ghiChuCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
      ...
      for (let i = 0; i < maxRows; i++) {
        ...
        const matchFormula = `IFERROR(MATCH(1,INDEX((Database!$E$2:$E${dbRowCount}=$D$1)*(Database!${seqColLetter}$2:${seqColLetter}${dbRowCount}=${seqNum}),0),0)+1,0)`;
        ...
        sttCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        if (i % 2 === 0) {
          sttCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
        }
        colIndex++;
        ...
        ngayDiCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        if (i % 2 === 0) {
          ngayDiCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
        }
        colIndex++;
        ...
        ngayVeCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        if (i % 2 === 0) {
          ngayVeCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
        }
        colIndex++;
        ...
        soBBCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        if (i % 2 === 0) {
          soBBCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
        }
        colIndex++;
        ...
        thietBiList.forEach((thietBi, tbIdx) => {
          ...
          diCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
          if (i % 2 === 0) {
            diCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
          }
          colIndex++;
          ...
          traCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
          if (i % 2 === 0) {
            traCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
          }
          colIndex++;
        });
        ...
        ghiChuDataCell.border = { top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" } };
        if (i % 2 === 0) {
          ghiChuDataCell.fill = { type: "pattern", pattern: "solid", fgColor: { argb: "FFF9FAFB" } };
        }
      }
      ...
      const fileName = `Bao_cao_TTB_Dynamic_${dayjs().format("YYYYMMDD_HHmmss")}.xlsx`;
      saveAs(blob, fileName);

      message.success({
        content: "Xuất Excel động thành công! Chọn mã cửa hàng ở ô D1 để xem báo cáo",
        key: "export",
        duration: 5
      });
    } catch (error) {
